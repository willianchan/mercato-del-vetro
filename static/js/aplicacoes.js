...
function movimentar() {
    ...
    div.id = "addBotao";
    div.innerHTML = '<a class="btn btn-primary btn-md botao-oco" style="margin-right: 10px;" href="admin_aplicacoes"> Cancelar</a> <a class="btn btn-primary btn-md textoBranco" style="cursor: pointer; background-color: #32CD32 !important; border-color: #32CD32 !important" onClick="salvar()"><i class="fas fa-check-circle"></i> Salvar</a>'
...
function salvar() {
    ...
    const div = document.createElement('div');
    div.id = "addBotao";
    div.innerHTML = '<a onClick="movimentar()" class="btn btn-primary btn-md textoBranco" style="margin-right: 10px;"><i class="fas fa-arrows-alt"></i>Movimentar</a> <a class="btn btn-primary btn-md textoBranco" href="adicionar_aplicacao"><i class="fas fa-plus-circle"></i> Adicionar</a>'
    document.getElementById("addBotao").remove();
    document.getElementById("botoes").appendChild(div);
    $("#getAplicacoes").sortable({
        disabled: true
...
function movimentarImagem(id, nome) {
    ...
    div.innerHTML = '<a class="btn btn-primary btn-md botao-oco" style="margin-right: 10px;" href="admin_aplicacoes">Cancelar</a><a class="btn btn-primary btn-md textoBranco" style="cursor: pointer; background-color: #32CD32 !important; border-color: #32CD32 !important" onClick="salvarImagem(' + id + ')"><i class="fas fa-check-circle"></i> Salvar</a>'
...
function salvarImagem(id) {
    ...
    div.innerHTML = '<a onClick="movimentarImagem(' + id + ')" class="btn btn-primary btn-md textoBranco" style="margin-right: 10px; cursor: pointer;"><i class="fas fa-arrows-alt"></i> Movimentar</a> <a class="btn btn-primary btn-md textoBranco" href="adicionar_imagem_aplicacao?id=' + id + '"><i class="fas fa-plus-circle"></i>Adicionar</a>'
