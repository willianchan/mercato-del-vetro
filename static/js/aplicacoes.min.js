                ...
                <div class="container small-modal-container">
                    ...
                    <div id="top`+ aplicacao.id + `">
                        <div class="row" id="rm1`+ aplicacao.id + `">
                            <div id="botoes`+ aplicacao.id + `" class="w-100">
                                <div id="addBotao`+ aplicacao.id + `" style="float:right;">
                                    <a onClick="movimentarImagem(`+ aplicacao.id + `)" class="btn btn-primary btn-md textoBranco"
                                    style="margin-right: 10px; cursor: pointer;"><i class="fas fa-arrows-alt"></i>
                                    Movimentar</a>
                                    <a class="btn btn-primary btn-md textoBranco" href="adicionar_imagem_aplicacao?id=`+ aplicacao.id + `"><i
...
function salvarImagem(id) {
    ...
    div.innerHTML = `
    <div id="top`+ id + `">
        <div class="row" id="rm1`+ id + `">
            <div id="botoes`+ id + `" class="w-100">
                <div id="addBotao`+ id + `" style="float:right;">
                    <a onClick="movimentarImagem(`+ id + `)" class="btn btn-primary btn-md textoBranco"
                    style="margin-right: 10px; cursor: pointer;"><i class="fas fa-arrows-alt"></i>
                    Movimentar</a>
                    <a class="btn btn-primary btn-md textoBranco" href="adicionar_imagem_aplicacao?id=`+ id + `"><i
                    class="fas fa-plus-circle"></i>Adicionar</a>
                </div>
            </div>
        </div>
        <div class="row text-center" id="rm2`+ id + `">
            <h2 id="titulo" class="text-uppercase text-center w-100">`+ titulo + `</h2>
        </div>
    </div>`
    ...
    document.getElementById("rm2" + id).remove();
