...
window.onload = async function () {
    var aplicacoes = get('http://localhost:5000/aplicacoes');
...
function addImagens(id) {
    var imagens = get('http://localhost:5000/imagens_aplicacoes/0/' + id);
...
function editarPosicao(id, posicao) {
    ...
    url = 'http://localhost:5000/aplicacoes/' + id + '/' + posicao;
...
function editarPosicao(imagem_id, posicao) {
    var http = new XMLHttpRequest();
    url = 'http://localhost:5000/imagens_aplicacoes/' + imagem_id + '/' + posicao;
    http.open('PUT', url, true);
    http.send();
}
