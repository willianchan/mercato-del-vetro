...
function addImagens(id) {
    ...
    for (imagem in imagens) {
        ...
        html += `
        <div class="fill col-lg-4 col-md-4 col-sm-6 col-xs-12 vidros-item">
            <a class="open-img" data-toggle="modal fill" href="#imgModal`+ imagens[imagem].id + `">
                <img class="img-produtos img-fluid" src="` + imagens[imagem].imagem + `" alt="">
            </a>
        </div>
        `;
